                    ...
                    <div key={index} className='w-[100%] h-[10%] border-t border-b'>
                        <div className='w-[100%] h-[80%] flex items-start gap-6 bg-[#51808048] py-[10px] px-[20px] rounded-2xl relative'>
                            ...
                            <div className='flex items-start justify-center flex-col gap-[5px]'>
                                ...
                                <div className='absolute md:right-[5%] right-[1%] md:top-[40%] top-[75%]'>
                                    <button className='md:px-[15px] md:py-[7px] rounded-md bg-[#101919] text-[#f3f9fc] text-[12px] md:text-[16px] cursor-pointer active:bg-slate-500' onClick={loadOrderData}> Track Order</button>
                                </div>
                            </div>
                        </div>
                    </div>
