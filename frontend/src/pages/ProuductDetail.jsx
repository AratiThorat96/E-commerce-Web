...
function ProductDetail() {
  ...
  return productData ? (
    <div>
      <div className="w-full min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-start flex-col lg:flex-row gap-[20px] pb-[40px]">
        ...
        <div className='lg:w-[50vw] w-full lg:min-h-[75vh] lg:mt-[80px] flex items-start justify-start flex-col py-[20px] px-[30px] md:pb-[20px] md:pl-[20px] lg:pl-[0px] lg:px-[0px] lg:py-[0px] gap-[10px]'>
